...
/**
 * @title UpdateRugNFTFacetFullFix
 * @notice Complete fix for RugNFTFacet to restore proper tokenURI functionality
 * @dev Adds ERC721URIStorage, fixes HTML generation, includes frame attributes
 */
contract UpdateRugNFTFacetFullFix is Script {
    ...
    function run() public {
        ...
        // Deploy new RugNFTFacet with full fixes
        ...
        console.log("Fixed tokenURI to generate full HTML instead of basic JSON");
        console.log("Added proper ERC721URIStorage support");
        console.log("Included frame level in metadata attributes");
