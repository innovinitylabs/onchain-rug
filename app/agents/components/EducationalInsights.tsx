    ...
    <div className="bg-white rounded-lg shadow-sm border">
      ...
      <div className="p-6 space-y-6">
              ...
              <div key={index} className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-sm font-semibold text-green-600">{insight.percentage}</span>
                  </div>
            ...
            {commonPitfalls.map((pitfall, index) => (
              <div key={index} className="p-3 bg-red-50 rounded-lg border border-red-200">
                <div className="flex items-start justify-between mb-2">
                  <h5 className="font-medium text-red-900">{pitfall.issue}</h5>
                  <span className="text-xs font-medium text-red-600 bg-red-100 px-2 py-1 rounded">
                    {pitfall.impact}
                  </span>
                </div>
                <p className="text-sm text-red-800">{pitfall.solution}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-6">
          <h4 className="text-md font-medium text-gray-900 mb-4">📖 Learning Resources</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <div>
                <div className="font-medium text-blue-900">Agent API Docs</div>
            ...
            >
              ...
              <div>
                <div className="font-medium text-purple-900">Source Code</div>
                <div className="text-sm text-purple-700">Fork and modify</div>
              </div>
            </a>
          </div>
        </div>
