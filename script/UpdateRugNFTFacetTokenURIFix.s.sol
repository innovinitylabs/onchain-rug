...
/**
 * @title UpdateRugNFTFacetTokenURIFix
 * @notice Fix tokenURI to pass frame name instead of frame number to HTML generator
 * @dev tokenURI was passing Strings.toString(frameLevel) instead of getFrameName(frameLevel)
 */
contract UpdateRugNFTFacetTokenURIFix is Script {
    ...
    function run() public {
        ...
        // Deploy new RugNFTFacet with fixed tokenURI
        ...
        console.log("Fixed tokenURI to pass frame name instead of frame number");
