...
/**
 * @title DeployShapeL2
 * @dev Deploy OnchainRugsV2Shape to Shape L2 mainnet
 */
contract DeployShapeL2 is Script {
    function run() external {
        uint256 deployerPrivateKey = vm.envUint("PRIVATE_KEY");
        address deployer = vm.addr(deployerPrivateKey);

        console.log("Deploying OnchainRugsV2Shape to Shape L2...");
        console.log("Deployer address:", deployer);
        console.log("Deployer balance:", deployer.balance / 1e18, "ETH");
        console.log("Network: Shape L2 (Chain ID: 360)");
        ...
        vm.writeFile("shape-l2-deployment.txt", deploymentInfo);
        console.log("Deployment info saved to shape-l2-deployment.txt");
    }
}
