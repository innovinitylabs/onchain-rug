...
contract UploadFixedLibraries is Script {
    ...
    function run() external {
        ...
        console.log("Uploading FIXED JavaScript libraries...");
        ...
        // Upload decoded p5.js library with a new name
        console.log("Uploading fixed p5.js...");
        uploadLibrary("onchainrugs-p5.js", "./data/rug-p5.js");

        // Upload decoded algorithm library with a new name
        console.log("Uploading fixed algorithm...");
        uploadLibrary("onchainrugs.js", "./data/rug-algo.js");

        vm.stopBroadcast();

        console.log("\\nLibraries uploaded with FIXED names!");
        console.log("New names:");
        console.log("- p5.js: onchainrugs-p5.js");
        console.log("- algorithm: onchainrugs.js");
        console.log("\\nIMPORTANT: Update OnchainRugsHTMLGenerator.sol to use these new names!");
    }
