...
/**
 * @title UpdateRugNFTFacetRemoveExists
 * @notice Remove the _exists override that was causing circular dependency
 * @dev The _exists override was calling ownerOf which created recursion
 */
contract UpdateRugNFTFacetRemoveExists is Script {
    ...
    function run() public {
        ...
        // Deploy new RugNFTFacet without _exists override
        ...
        console.log("Removed _exists override that was causing circular dependency");
