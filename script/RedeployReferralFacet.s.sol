...
/**
 * @title RedeployReferralFacet
 * @notice Redeploy the RugReferralRegistryFacet with fixes
 */
contract RedeployReferralFacet is Script {
    ...
    function run() external {
        ...
        console.log("Redeploying RugReferralRegistryFacet for diamond at:", diamondAddr);
        ...
        console.log("Successfully redeployed RugReferralRegistryFacet!");
    }
}