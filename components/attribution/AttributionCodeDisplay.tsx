    ...
    <Card className="w-full max-w-md">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-green-300">Your ERC-8021 Attribution Code</label>
        ...
        {/* Sharing URL */}
        <div className="space-y-3">
          <label className="text-sm font-medium text-green-300">Your ERC-8021 Attribution Link</label>
          <div className="flex gap-2">
            <input
              value={getSharingUrl()}
              readOnly
