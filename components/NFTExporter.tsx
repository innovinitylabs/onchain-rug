...
const NFTExporter: React.FC = () => {
  ...
  const safeSeed = doormatData?.seed || 42;
  const safePalette = doormatData?.selectedPalette || { name: 'Default', colors: ['#000000', '#FFFFFF'] };
  const safeStripeData = doormatData?.stripeData || [];
  const safeTextRows = doormatData?.doormatTextRows || [];
