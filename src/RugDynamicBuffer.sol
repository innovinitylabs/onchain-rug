...
library RugDynamicBuffer {
    /// @notice Allocates container space for the RugDynamicBuffer
        ...
        pure
    {
        ...
        if (cap < newLength) {
            revert("RugDynamicBuffer: Appending out of bounds.");
        }
    }
}
